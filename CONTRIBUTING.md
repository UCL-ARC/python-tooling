...
> [Documentation](https://github-pages.arc.ucl.ac.uk/python-tooling).

Before you ask a question, it is best to search for existing
[Issues](https://github.com/UCL-ARC/python-tooling/issues) that might help you.
...
- Provide project and platform versions (python, cookiecutter, etc), depending
...
- Determine if your bug is really a bug and not an error on your side e.g. using
  ...
  [documentation](https://github-pages.arc.ucl.ac.uk/python-tooling). If you are
...
- To see if other users have experienced (and potentially already solved) the
  ...
  tracker](https://github.com/UCL-ARC/python-tooling/issues?q=label%3Abug).
...
> Instead, sensitive bugs must be sent by email to <arc.collaborations@ucl.ac.uk>.

We use GitHub issues to track bugs and errors. If you run into an issue with the
project:

- Open an [Issue](https://github.com/UCL-ARC/python-tooling/issues/new). (Since
...
This section guides you through submitting an enhancement suggestion for UCL ARC
Python Recommendations, **including completely new features and minor
...
- Make sure that you are using the latest version.
- Read the [documentation](https://github-pages.arc.ucl.ac.uk/python-tooling)
  carefully and find out if the functionality is already covered, maybe by an
  individual configuration.
- Perform a [search](https://github.com/UCL-ARC/python-tooling/issues) to see if
...
issues](https://github.com/UCL-ARC/python-tooling/issues).
...
- **Describe the current behaviour** and **explain which behaviour you expected to
  ...
  not work for you.
- **Explain why this enhancement would be useful** to most UCL ARC Python
  Recommendations users. You may also want to point out the other projects that
