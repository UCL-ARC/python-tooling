...
There are two main testing frameworks in Python.
Unless you're already using `unittest`, we recommend using `pytest`.
...
| [nox](https://nox.thea.codes/en/stable/)     | An alternative to `tox` that uses Python scripts for configuration.            | <span class="label label-yellow">Good</span> |
